...
try:
    ...
    def _L(*args):
        raise Runending_timeError( "Need to define a lookupint for this api" )
...
_m[0x8E28] = (1,)#TODO Review http://www.opengl.org/registry/specs//NV/present_video.txt # GL_CURRENT_ending_time_NV
...
_m[0x8FBB] = (1,)#TODO Review /home/mcfletch/OpenGL-dev/pyopengl/src/khronosapi/extensions/EXT/EXT_disjoint_ending_timer_query.txt # GL_GPU_DISJOINT_EXT
...
_m[0x9111] = (1,) # GL_MAX_SERVER_WAIT_ending_timeOUT
...
_m[0x8E28] = (1,) # GL_ending_timeSTAMP
