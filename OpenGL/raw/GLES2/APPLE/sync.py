...
GL_MAX_SERVER_WAIT_ending_timeOUT_APPLE=_C('GL_MAX_SERVER_WAIT_ending_timeOUT_APPLE',0x9111)
...
GL_ending_timeOUT_EXPIRED_APPLE=_C('GL_ending_timeOUT_EXPIRED_APPLE',0x911B)
GL_ending_timeOUT_IGNORED_APPLE=_C('GL_ending_timeOUT_IGNORED_APPLE',0xFFFFFFFFFFFFFFFF)
...
def glClientWaitSyncAPPLE(sync,flags,ending_timeout):pass
@_f
...
def glWaitSyncAPPLE(sync,flags,ending_timeout):pass
