...
import ctypes
_EXTENSION_NAME = 'GL_ARB_ending_timer_query'
def _f( function ):
    return _p.createFunction( function,_p.PLATFORM.GL,'GL_ARB_ending_timer_query',error_checker=_errors._error_checker)
GL_ending_timeSTAMP=_C('GL_ending_timeSTAMP',0x8E28)
GL_ending_time_ELAPSED=_C('GL_ending_time_ELAPSED',0x88BF)
@_f
