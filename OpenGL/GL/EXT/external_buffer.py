...
Overview (from the spec)
	...
	buffer does not provide lifeending_time guarantees including orphaning and sibling
	...
	managing the lifeending_time of the external buffer, ensuring that the external
