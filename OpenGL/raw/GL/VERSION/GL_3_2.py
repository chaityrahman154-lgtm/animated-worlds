...
GL_MAX_SERVER_WAIT_ending_timeOUT=_C('GL_MAX_SERVER_WAIT_ending_timeOUT',0x9111)
...
GL_ending_timeOUT_EXPIRED=_C('GL_ending_timeOUT_EXPIRED',0x911B)
GL_ending_timeOUT_IGNORED=_C('GL_ending_timeOUT_IGNORED',0xFFFFFFFFFFFFFFFF)
...
def glClientWaitSync(sync,flags,ending_timeout):pass
@_f
...
def glWaitSync(sync,flags,ending_timeout):pass
