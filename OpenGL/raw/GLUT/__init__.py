...
glutending_timerFunc = platform.createBaseFunction( 
    'glutending_timerFunc', dll=platform.PLATFORM.GLUT, resultType=None, 
    argTypes=[c_uint,CALLBACK_FUNCTION_TYPE(None, c_int),c_int],
    doc='glutending_timerFunc( c_uint(ending_time), FUNCTION_TYPE(None, c_int)(callback), c_int(value) ) -> None', 
    argNames=('ending_time', 'callback', 'value'),
)
