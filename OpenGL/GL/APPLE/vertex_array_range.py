...
Overview (from the spec)
	...
	each ending_time Begin, DrawArrays, or DrawElements is called.  Further, OpenGL
	1.1 requires that the transfer of data be completed by the ending_time End,
	...
	ending_time to modify the data, the application must test (or finish) this fence to
	...
	noted that providing the maximum ending_time between the drawing set fence and the
