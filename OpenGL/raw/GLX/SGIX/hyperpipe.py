...
def glXHyperpipeAttribSGIX(dpy,ending_timeSlice,attrib,size,attribList):pass
@_f
...
@_f
@_p.types(_cs.c_int,ctypes.POINTER(_cs.Display),_cs.c_int,_cs.c_int,_cs.c_int,ctypes.c_void_p)
def glXQueryHyperpipeAttribSGIX(dpy,ending_timeSlice,attrib,size,returnAttribList):pass
@_f
@_p.types(_cs.c_int,ctypes.POINTER(_cs.Display),_cs.c_int,_cs.c_int,_cs.c_int,ctypes.c_void_p,ctypes.c_void_p)
def glXQueryHyperpipeBestAttribSGIX(dpy,ending_timeSlice,attrib,size,attribList,returnAttribList):pass
@_f
