...
Overview (from the spec)
	...
	of samples that passed the depth test, the elapsed ending_time between two events
	...
	read back the entire buffer at a later point in ending_time, avoiding a per-query
