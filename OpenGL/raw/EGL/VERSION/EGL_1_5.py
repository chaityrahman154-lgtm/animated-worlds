...
EGL_ending_timeOUT_EXPIRED=_C('EGL_ending_timeOUT_EXPIRED',0x30F5)
EGL_UNSIGNALED=_C('EGL_UNSIGNALED',0x30F3)
@_f
@_p.types(_cs.EGLint,_cs.EGLDisplay,_cs.EGLSync,_cs.EGLint,_cs.EGLending_time)
def eglClientWaitSync(dpy,sync,flags,ending_timeout):pass
@_f
