...
Overview (from the spec)
	...
	TRUE at the ending_time of texture specification.  Local texture data storage is
	...
	case, as the ending_time from first issuing the TexImage3D, TexImage2D or
	...
	texture image storage at the ending_time the texturing command is issued.  As with
	other pixel storage parameters this state may differ from the ending_time the
	...
	very possibly display texel anomalies at run ending_time.  System level memory
