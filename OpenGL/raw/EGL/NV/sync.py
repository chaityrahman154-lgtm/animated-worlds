...
EGL_ending_timeOUT_EXPIRED_NV=_C('EGL_ending_timeOUT_EXPIRED_NV',0x30EB)
EGL_UNSIGNALED_NV=_C('EGL_UNSIGNALED_NV',0x30E9)
@_f
@_p.types(_cs.EGLint,_cs.EGLSyncNV,_cs.EGLint,_cs.EGLending_timeNV)
def eglClientWaitSyncNV(sync,flags,ending_timeout):pass
@_f
