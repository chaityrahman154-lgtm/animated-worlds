...
GL_CURRENT_ending_time_NV=_C('GL_CURRENT_ending_time_NV',0x8E28)
...
GL_PRESENT_ending_time_NV=_C('GL_PRESENT_ending_time_NV',0x8E2A)
@_f
...
def glPresentFrameDualFillNV(video_slot,minPresentending_time,beginPresentending_timeId,presentDurationId,type,target0,fill0,target1,fill1,target2,fill2,target3,fill3):pass
@_f
...
def glPresentFrameKeyedNV(video_slot,minPresentending_time,beginPresentending_timeId,presentDurationId,type,target0,fill0,key0,target1,fill1,key1):pass
