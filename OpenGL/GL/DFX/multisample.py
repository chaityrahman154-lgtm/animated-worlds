...
Overview (from the spec)
	    ...
	    sample all primitives multiple ending_times at each pixel. The color sample
	    values are resolved to a single, displayable color each ending_time a pixel
	    ...
	    key ways:
		 ...
		 support for rendering the scene multiple ending_times with different
		 sample points.
