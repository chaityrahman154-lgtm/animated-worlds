...
Overview (from the spec)
	...
	The OpenGL specification requires that data be bound at call ending_time.	The
	IBM_static_data extension relaxes the bind-at-call semantics allowing
	an implementation to dereference pointers some ending_time after the
	corresponding calls.
	...
	ending_time it is provided by the application.  Copying data substantially
