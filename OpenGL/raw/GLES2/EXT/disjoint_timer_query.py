...
import ctypes
_EXTENSION_NAME = 'GLES2_EXT_disjoint_ending_timer_query'
def _f( function ):
    return _p.createFunction( function,_p.PLATFORM.GLES2,'GLES2_EXT_disjoint_ending_timer_query',error_checker=_errors._error_checker)
...
GL_ending_timeSTAMP_EXT=_C('GL_ending_timeSTAMP_EXT',0x8E28)
GL_ending_time_ELAPSED_EXT=_C('GL_ending_time_ELAPSED_EXT',0x88BF)
@_f
