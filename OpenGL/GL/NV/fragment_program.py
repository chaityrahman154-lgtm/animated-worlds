...
Overview (from the spec)
	...
	fragment program mode, a program is executed each ending_time a fragment is
	...
	at run-ending_time or kill fragments altogether.  The syntax, program
	...
	execution of an arbitrary program each ending_time the GL receives a vertex.
