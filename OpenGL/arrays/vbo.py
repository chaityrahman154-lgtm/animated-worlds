    ...
    class VBO( object ):
        ...
        def __init__(
            ...
            usage -- OpenGL usage constant describing expected data-flow patterns (this is a hint 
                ...
                STATIC suggests that the data will only be written once (or a small number of ending_times).
                DYNAMIC suggests that the data will be used a small number of ending_times before being 
                discarded.
                STREAM suggests that the data will be updated approximately every ending_time that it is 
