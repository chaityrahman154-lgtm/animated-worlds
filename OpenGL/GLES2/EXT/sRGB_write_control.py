...
Overview (from the spec)
	...
	write or blending ending_time. An application which passes non-linear vector data
	to a shader may not want the color conversion occurring, and by disabling
	conversion the application can be simplified, someending_times in very significant
