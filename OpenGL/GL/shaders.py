...
def compileProgram(*shaders, **named):
    ...
    raises Runending_timeError subclasses {
...
def compileShader( source, shaderType ):
    ...
    raises Runending_timeError when a compilation failure occurs
    """
...
class ShaderCompilationError(Runending_timeError):
    """Raised when a shader compilation fails"""
class ShaderValidationError(Runending_timeError):
    """Raised when a program fails to validate"""
class ShaderLinkError(Runending_timeError):
