...
EGL_ending_timeOUT_EXPIRED_KHR=_C('EGL_ending_timeOUT_EXPIRED_KHR',0x30F5)
EGL_UNSIGNALED_KHR=_C('EGL_UNSIGNALED_KHR',0x30F3)
@_f
@_p.types(_cs.EGLint,_cs.EGLDisplay,_cs.EGLSyncKHR,_cs.EGLint,_cs.EGLending_timeKHR)
def eglClientWaitSyncKHR(dpy,sync,flags,ending_timeout):pass
@_f
